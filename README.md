...
| 環境 | 構成図 | 内容 |
| --- | --- | --- |
| 検証環境 | [diagrams/windows-ilb-stg-architecture.svg](diagrams/windows-ilb-stg-architecture.svg) | 接続経路、最小サーバー構成、Single-AZ RDS を確認する環境 |
...
│   └── windows-ilb-stg-architecture.svg
├── docs
│   ├── architecture.md
│   └── operations.md
├── examples
